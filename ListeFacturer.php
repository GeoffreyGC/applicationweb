...
$sql2 = "SELECT * FROM facturer ORDER BY date DESC";
$rs_select2 = $pdo->prepare($sql2);
$rs_select2->execute();

$sql2m = "SELECT * FROM facturer ORDER BY date DESC";
...
if(isset($_POST['barre'])){
    ...
    $sql2 = "SELECT * FROM facturer WHERE Client = '{$nomC}' ORDER BY date DESC";
    $rs_select2 = $pdo->prepare($sql2);
    $rs_select2->execute();
}
...
if(isset($_POST['barrem'])){
    $nomC = $_POST['barrem'];
    $sql2m = "SELECT * FROM facturer WHERE Client = '{$nomC}' ORDER BY date DESC";
    $rs_select2m = $pdo->prepare($sql2m);
    $rs_select2m->execute();
}
...
if(isset($_POST['rechercher'])){
    ...
    if($nomC != 1){
        ...
        $sql3 = "SELECT * FROM facturer WHERE Client = '{$nomC}' ORDER BY date DESC ";
        $rs_select3 = $pdo->prepare($sql3);
        $rs_select3->execute();
        
        }else{
            
        $sql3 = "SELECT * FROM facturer WHERE date BETWEEN '{$date1}' AND '{$date2}' AND Client = '{$nomC}' ORDER BY date DESC ";
        $rs_select3 = $pdo->prepare($sql3);
        $rs_select3->execute();}
        ...
        $sql3 = "SELECT * FROM facturer WHERE date BETWEEN '{$date1}' AND '{$date2}' ORDER BY date DESC";
        $rs_select3 = $pdo->prepare($sql3);
        $rs_select3->execute();
    }
   }
...
crossorigin="anonymous"/>
    ...
    <body>
        ...
        <div class="bg-white p-3 text-white col container-fluid text-center">
        ...
        <div class="row">    
            <form action="" method="post" name="form" class="col-3 orange p-1 text-center container-fluid">
                <p>  </p>
                <input class="" type="search"  name="barre" placeholder="client précis">
            ...
            ?>
                ...
                De  <input class="" type="date"  name="date1">
                
              
                à   <input class="" type="date"  name="date2">
                
            <input type="submit" name="rechercher" value="Rechercher"> <a class="leBouton container-fluid" href="ListeFacturer.php">Toutes les interventions</a>
            </form>
            </div>
            </div>
        ...
        <div class="mobile">
            <div class="row">
                ...
                <input type="submit" name="rechercherm" value="Rechercher"> <a class="leBouton container-fluid" href="ListeFacturer.php">Toutes les interventions</a>
                </form>
            </div>
        </div>
        
        <div class="container-fluid bg-dark p-1 col-12">
            <h3 class="text-center text-white">Interventions à facturer</h3>
        </div>
        ...
        ?>
                ...
                <a class="col container-fluid" href="detailf.php?id=<?= $donnees['IdInterF']; ?>">Details</a><a class="col container-fluid" href="modiffacture.php?id=<?= $donnees['IdInterF']; ?>">Modifier</a><a class="col container-fluid" href="/deletef.php?id=<?= $donnees['IdInterF']; ?>" >Supprimer</a>
            </div>
                </div>
        ...
        ?>
                ...
                <div class="col container-fluid">
                    ...
                    <a class="col container-fluid" href="detailf.php?id=<?= $donnees['IdInterF']; ?>">Details</a><p> </p>
            </div>
                </div>
