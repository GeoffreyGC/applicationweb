    ...
    <body>
        ...
        <script>
            ...
            <div class="container-fluid col bg-dark p-1">
                <h6 class="text-center text-white">Intervention</h6>
            </div>
        ...
        <div class="col">
                ...
                <div class="col">
                    <b><p>Description</p></b> <br/> 
                    <p><?= $donnees['Description']; ?></p>
                </div>
                </div>
            
                <a class="leBouton col" href="ListeIntervention.php">Retour</a>
                <a class="leBouton col" href="ModifierIntervention.php?id=<?= $donnees['IDintervention']; ?>">Modifier</a>
                <a class="leBouton col" href="delete.php?id=<?= $donnees['IDintervention']; ?>" >Supprimer</a>
            </div>
        <br/>
        <br/>
        <br/>
        ...
        <div class="col">
                ...
                <a class="leBouton col" href="DetailClient2.php?id=<?= $donnees['Client']; ?>">Retour</a>
                <a class="leBouton col" href="ModifierInterM.php?id=<?= $donnees['IDintervention']; ?>">Modifier</a>
                <a class="leBouton col" href="delete.php?id=<?= $donnees['IDintervention']; ?>" >Supprimer</a>
            </div>
        <br/>
        <br/>
