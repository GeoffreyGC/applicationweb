...
$var_desc = $_POST['description'];
        ...
        $rs_insert = $pdo->prepare("INSERT INTO facturer (date,Client,nomUtilisateur,ssmf,genreIntervention,temps,TypeIntervention,Description) VALUES (?,?,?,?,?,?,?,?)");
        ...
        $rs_insert->bindValue(5,$var_radiointer,PDO::PARAM_STR);
        $rs_insert->bindValue(6,$var_temps,PDO::PARAM_STR);
        $rs_insert->bindValue(7,$var_type,PDO::PARAM_STR);
        $rs_insert->bindValue(8,$var_desc,PDO::PARAM_STR);
...
crossorigin="anonymous"/>
    ...
    <body>
        ...
        <div class="container-fluid bg-dark p-1">
            <h3 class="col-12 text-center text-white">Enregistrer une intervention à facturer</h3>
        </div>
