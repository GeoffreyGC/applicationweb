...
if(isset($_GET['id'])){
$sql = "DELETE FROM suiviintervention WHERE IDintervention = ?";
$rs_sup = $pdo->prepare($sql);

$var_inter = $_GET['id'];

$rs_sup->execute(array($var_inter));

$message = '<p class="text-center text-success">Intervention supprimée</p>';
} else {
    $message = '<p class="text-center text-danger">Une erreur est survenue lors de la suppression</p>';
}
?>
<!DOCTYPE html>
<html>
...
crossorigin="anonymous"/>
    ...
    <body>
        ...
        <div class="container-fluid bg-dark p-1">
            <h6 class="col-12 text-center text-white">Supprimer une intervention</h6>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-6">
                <?= $message; ?>
                <a class="leBouton col-2 text-center" href="ListeIntervention.php">Retour</a>
            </div>
