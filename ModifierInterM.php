...
crossorigin="anonymous"/>
   ...
   <form action="" method="post" name="formulaire" class="col-6 bg-light">
            ...
            <div>
                ...
                <div id='radioClient' name='radioClient'>
                    <input type="radio" id="radio2" name="radioClient" value="Maintenance informatique" ><label for="radio2">Maintenance informatique</label><br />
                    <input type="radio" id="radio3" name="radioClient" value="Maintenance telephonie" ><label for="radio3">Maintenance téléphonie</label>
                </div>
            </div>
   ...
   <form action="" method="post" name="formulaire" class="col bg-light text-center">
            ...
            <div>
                <label for='radioclientm'>Client sous maintenance ou à facturer ?</label></br>
                <div id='radioClient' name='radioClientm'>
                    <input type="radio" id="radio2" name="radioClientm" value="Maintenance informatique" ><label for="radio2">Maintenance informatique</label><br />
                    <input type="radio" id="radio3" name="radioClientm" value="Maintenance telephonie" ><label for="radio3">Maintenance téléphonie</label>
                </div>
            </div>
            ...
            <a class="leBouton" href="Intervention.php">Nouvelle intervention</a>
            <a class="leBouton" href="MobileDetailClient.php?id=<?= $_GET['id'] ?>">Retour</a>
            <br/>
            <p>   </p>
            </fieldset>
        </form>
