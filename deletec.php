...
$rs_sup->execute(array($var_client));

$message = '<p class="text-center text-success">Client supprimée</p>';
} else {
...
crossorigin="anonymous"/>
    ...
    <body>
        ...
        <div class="container-fluid bg-dark p-1">
            <h6 class="col-12 text-center text-white">Supprimer un client</h6>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-6">
                <?= $message; ?>
                <a class="leBouton col-2 text-center" href="ListeClient.php">Retour</a>
            </div>
