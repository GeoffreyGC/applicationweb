...
$sql = "SELECT * FROM contrat GROUP BY contrat";
$rs_select = $pdo->prepare($sql);
$rs_select->execute();

$sqlm = "SELECT * FROM contrat GROUP BY contrat";
...
crossorigin="anonymous"/>
    ...
    <body>
        ...
        <div class="container-fluid bg-dark p-1 col-12">
            <h6 class="text-center text-white">Contrat</h6>
        </div>
        ...
        <div class="pc">
           ...
           <div class='row'>
                <b class="col-2"><p>Type de contrat</p></b>
                <a class="col text-warning" href="addcontrat.php">Ajouter un type de contrat</a>  
            </div>
            </div>
        ...
        ?>   
            ...
            <div class="row">
                ...
                <a class="col-1" href="modifcontrat.php?id=<?= $donnees['idcontrat']; ?>">Modifier</a><a class="col-1" href="deletecontrat.php?id=<?= $donnees['idcontrat']; ?>">Supprimer</a> 
            </div>
        ...
        <div class="mobile">
           ...
           <div class='row'>
                <b class="col-5"><p>Type de contrat</p></b>
                <a class="col text-warning" href="addcontrat.php">Ajouter un type de contrat</a>  
            </div>
            </div>
        ...
        ?>   
            ...
            <div class="row">
                ...
                <a class="col" href="modifcontrat.php?id=<?= $donnees['idcontrat']; ?>">Modifier</a><a class="col" href="deletecontrat.php?id=<?= $donnees['idcontrat']; ?>">Supprimer</a> 
            </div>
