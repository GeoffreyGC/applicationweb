...
$var_Contrat = $_POST['contrat'];
        ...
        $rs_insert = $pdo->prepare("INSERT INTO contrat (contrat) VALUES (?)");
   
        $rs_insert->bindValue(1,$var_Contrat,PDO::PARAM_STR);

        if($rs_insert->execute()){
        
        $message = '<p class="msgGreen">Type de contrat enregistrée</p>';
        
        
        }else{
            $message = "<p class='msgRed'>Probleme avec l'enregistrement du type de contrat, veuillez ressayer</p>"; 
        }
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Nouveau type de contrat</title>
    ...
    <body>
        ...
        <form action="" method="post" name="formulaire" class="col-12 text-center bg-light">
            ...
            <div>
                ...
                <input type="text" id="contrat" name='contrat' placeholder="Veuillez entrer le type de contrat" size="32" required>
            </div>
            ...
            <a class="leBouton" href="addcontrat.php">Nouveau type de contrat</a>
            <br/>
            <p>   </p>
            </fieldset>
        </form>
